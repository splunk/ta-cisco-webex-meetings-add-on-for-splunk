...
import input_module_meetings_history_service as input_module
...
'''
    ...
    Add your modular input logic to file input_module_meetings_history_service.py
'''
class ModInputmeetings_history_service(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def get_scheme(self):
        ...
        scheme = super(ModInputmeetings_history_service, self).get_scheme()
...
if __name__ == "__main__":
    exitcode = ModInputmeetings_history_service().run(sys.argv)
    sys.exit(exitcode)
